...
var _tween : Tween
func gain(
	_text:String, _wait:float=0.75,  _duration:float=0.75, _movement:Vector2=Vector2(0,-10),
	...
	_tween.tween_property(get_child(0),"self_modulate",self_modulate * 5,_duration).set_ease(Tween.EASE_IN)
